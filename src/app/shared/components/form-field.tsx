...
// forwardRef is required on React 18 so react-hook-form's register() can attach
// to the underlying input/textarea — a plain `ref` prop never reaches a
// function component and the form silently loses the field.
export const FormField = forwardRef<HTMLInputElement | HTMLTextAreaElement, FormFieldProps>(
  function FormField({ label, error, multiline, className, ...props }, ref) {
